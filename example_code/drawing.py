...
for i in xrange(0, 25):
    ...
    colour = np.random.randint(0, high=256, size=(3,) ).tolist() # Create three different values from 0-256 and save them as a list
    center = np.random.randint(0, high=300, size=(2,) ).tolist() # Create two different values from 0-300 and save them as a list
